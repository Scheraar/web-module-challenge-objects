...
function createThreeItems(obj, name, price, category) {
  obj = { name, price, category };
  return obj;
}
console.log(createThreeItems("pizza", "Pizza", 6.99, "lunch"));
console.log(createThreeItems("hot dogs", "Hot Dogs", 3.99, "lunch"));
console.log(createThreeItems("icecream", "IceCream", 5.99, "dessert"));
...
function addRating(array, name, rating, feedback) {
  array.unshift({ name, rating, feedback });
  return array;
}
console.log(addRating(reviews, "Bob", 5, "Sucked"));
/* Task 5: Add the following feedback to Reyna's rating - "this place is chill with really cool people, great for getting work done on weekdays"*/
const changeFeedback = (array, index, key, updatedValue) => {
  array[index][key] = updatedValue;
  return array;
};
console.log(changeFeedback(reviews, 8, "feedback", "This place is chill with really cool people, great for getting work done on weekdays"));
...
function getReviewByIndex(review, index) {
  return `${review[index].name} gave the restaurant a ${review[index].rating}, and their feedback was: ${review[index].feedback}`;
}
